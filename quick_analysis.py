...
sales_by_location = recent_data.groupby(['Drug_ID', 'Pharmacy_Name']).agg(
...
if not urgent_items.empty:
    print(urgent_items[['Drug_ID', 'Pharmacy_Name', 'current_stock', 'days_supply_remaining', 'restock_needed']].head())
